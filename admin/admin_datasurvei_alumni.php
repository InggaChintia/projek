...
$sql = "SELECT 
            ...
            r.tahun_lulus
        FROM 
            t_responden_alumni r
        JOIN 
            t_jawaban_alumni j ON r.responden_alumni_id = j.responden_alumni_id
        JOIN 
                        ...
                        <tbody>
                            <?php while ($row = $result->fetch_assoc()) : ?>
                                <tr>
                                    ...
                                    <td>
                                        <button class="btn btn-info" data-toggle="modal" data-target="#userModal<?php echo $row['responden_alumni_id']; ?>">Lihat Profil</button>

                                        <!-- Modal -->
                                        <div class="modal fade" id="userModal<?php echo $row['responden_alumni_id']; ?>" tabindex="-1" role="dialog" aria-labelledby="userModalLabel" aria-hidden="true">
                                            <div class="modal-dialog" role="document">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        ...
                                                        <p><strong>Tahun Lulus:</strong> <?php echo $row['tahun_lulus']; ?></p>
                                                    </div>
