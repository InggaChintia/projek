...
$sql = "SELECT 
            ...
            r.responden_industri_id,
            r.responden_jabatan,
            r.responden_perusahaan,
            r.responden_email,
            r.responden_hp,
            r.responden_kota
        FROM 
            t_responden_industri r
        JOIN 
            t_jawaban_industri j ON r.responden_industri_id = j.responden_industri_id
        JOIN 
...
<body>
    ...
    <div class="content">
        ...
        <div class="survey-content">
            <h2>Detail Data Survei Industri</h2>
            <hr class="nav-divider">
                        ...
                        <tbody>
                            <?php while ($row = $result->fetch_assoc()) : ?>
                                <tr>
                                    ...
                                    <td>
                                        <button class="btn btn-info" data-toggle="modal" data-target="#userModal<?php echo $row['responden_industri_id']; ?>">Lihat Profil</button>

                                        <!-- Modal -->
                                        <div class="modal fade" id="userModal<?php echo $row['responden_industri_id']; ?>" tabindex="-1" role="dialog" aria-labelledby="userModalLabel" aria-hidden="true">
                                            <div class="modal-dialog" role="document">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        ...
                                                        <p><strong>Jabatan:</strong> <?php echo $row['responden_jabatan']; ?></p>
                                                        <p><strong>Perusahaan:</strong> <?php echo $row['responden_perusahaan']; ?></p>
                                                        <p><strong>Email:</strong> <?php echo $row['responden_email']; ?></p>
                                                        <p><strong>No.Hp:</strong> <?php echo $row['responden_hp']; ?></p>
                                                        <p><strong>Kota:</strong> <?php echo $row['responden_kota']; ?></p>
