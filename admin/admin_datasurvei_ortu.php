...
$sql = "SELECT  
            ...
            r.responden_umur,
            r.responden_hp,
            r.responden_pendidikan,
            r.responden_pekerjaan,
            r.responden_penghasilan,
            r.mahasiswa_nim,
            r.mahasiswa_nama,
            r.mahasiswa_prodi
        FROM 
...
<body>
    ...
    <div class="content">
        ...
        <div class="survey-content">
            <h2>Detail Data Survei Orang Tua/Wali</h2>
            <hr class="nav-divider">
                    ...
                    <table class="table">
                        ...
                        <?php while ($row = $result->fetch_assoc()) : ?>
                            <tr>
                                ...
                                <td>
                                    <button class="btn btn-info" data-toggle="modal" data-target="#userModal<?php echo $row['responden_ortu_id']; ?>">Lihat Profil</button>

                                    <!-- Modal -->
                                    <div class="modal fade" id="userModal<?php echo $row['responden_ortu_id']; ?>" tabindex="-1" role="dialog" aria-labelledby="userModalLabel" aria-hidden="true">
                                        <div class="modal-dialog" role="document">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    ...
                                                    <p><strong>Jenis Kelamin:</strong> <?php echo $row['responden_jk']; ?></p>
                                                    <p><strong>Umur:</strong> <?php echo $row['responden_umur']; ?></p>
                                                    <p><strong>No.Hp:</strong> <?php echo $row['responden_hp']; ?></p>
                                                    <p><strong>Pendidikan:</strong> <?php echo $row['responden_pendidikan']; ?></p>
                                                    <p><strong>Penghasilan:</strong> <?php echo $row['responden_penghasilan']; ?></p>
                                                    <p><strong>NIM Mahasiswa:</strong> <?php echo $row['mahasiswa_nim']; ?></p>
                                                    <p><strong>Nama Mahasiswa:</strong> <?php echo $row['mahasiswa_nama']; ?></p>
                                                    <p><strong>Prodi Mahasiswa:</strong> <?php echo $row['mahasiswa_prodi']; ?></p>
                                                </div>
