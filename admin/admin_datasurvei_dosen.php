...
$sql = "SELECT 
            ...
            r.responden_dosen_id,
            r.responden_nip,
            r.responden_unit
        FROM 
            t_responden_dosen r
        JOIN 
            t_jawaban_dosen j ON r.responden_dosen_id = j.responden_dosen_id
        JOIN 
...
<body>
    ...
    <div class="content">
        ...
        <div class="survey-content">
            <h2>Detail Data Survei Dosen</h2>
            <hr class="nav-divider">
                        ...
                        <tbody>
                            <?php while ($row = $result->fetch_assoc()) : ?>
                                <tr>
                                    ...
                                    <td>
                                        <button class="btn btn-info" data-toggle="modal" data-target="#userModal<?php echo $row['responden_dosen_id']; ?>">Lihat Profil</button>

                                        <!-- Modal -->
                                        <div class="modal fade" id="userModal<?php echo $row['responden_dosen_id']; ?>" tabindex="-1" role="dialog" aria-labelledby="userModalLabel" aria-hidden="true">
                                            <div class="modal-dialog" role="document">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        ...
                                                        <p><strong>NIDN:</strong> <?php echo $row['responden_nip']; ?></p>
